		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Promise",
									"targetURL": "#comsappromisepromisefunction-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsappromisepromisefunction-display": {
								"semanticObject": "comsappromisepromisefunction",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.promise.promisefunction",
									"url": sap.ui.require.toUrl("com/sap/promise/promisefunction")
								}
							}
						}
					}
